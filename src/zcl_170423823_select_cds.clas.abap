CLASS zcl_170423823_select_cds DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423823_select_cds IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        get_result_from_cds( EXPORTING carrier_id = carrier_id connection_id = connection_id IMPORTING airport_from_id = airport_from_id airport_to_id = airport_to_id carrier_name = carrier_name ).
