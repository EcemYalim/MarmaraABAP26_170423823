CLASS zcl_170423823_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423823_rest_client_02 IMPLEMENTATION.
...
*    io_out->write( user_delete( ) ).
  ENDMETHOD.
    ...
    METHOD user_get.
      rv_text = execute_request(
        iv_method = 'GET'
        iv_url    = gc_base_url && '/user/demo_170423823' ).
    ENDMETHOD.
    ...
    METHOD execute_request.
      ...
      METHOD build_user_json.
        ...
        '{' &&
          '"id": 125,' &&
      '"username": "demo_170423823",' &&
      '"firstName": "yagiz",' &&
      '"lastName": "yesilyurt",' &&
      '"email": "yagizyesilyurt25@gmail.com",' &&
      '"password": "1234",' &&
      '"phone": "5554443366",' &&
      '"userStatus": 1' &&
      '}'.
