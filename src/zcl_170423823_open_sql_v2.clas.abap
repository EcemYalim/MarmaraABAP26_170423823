CLASS zcl_170423823_open_sql_v2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423823_open_sql_v2 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
        lt_insert TYPE TABLE OF z170423823_t_emp.
    DELETE FROM z170423823_t_emp.

    lt_insert = VALUE #( ( emp_id = '0000000001' name = 'Ali' currency = 'TRY' unit = 'PC' amount = '1000.01' quantity = 10 )
    ...
    SELECT emp_id FROM z170423823_t_emp
    UNION ALL
    SELECT emp_id FROM z170423823_t_emp
