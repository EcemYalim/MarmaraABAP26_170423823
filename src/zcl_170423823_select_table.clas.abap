CLASS zcl_170423823_select_table DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170423823_select_table IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        connection_id = connection_id IMPORTING airport_from_id = airport_from_id airport_to_id = airport_to_id ).
